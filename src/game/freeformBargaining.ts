...
{
  "intent": "trade_offer" | "clarification_needed",
  "toFaction": "vega_exchange" | "sirius_guild" | "nova_relief" | "free_caravans" | "dust_runners",
  "offered": { "credits": 0, "food": 0, "water": 0, "fuel": 0, "medicine": 0, "ore": 0, "star_silk": 0, "alien_relics": 0 },
  "requested": { "credits": 0, "food": 0, "water": 0, "fuel": 0, "medicine": 0, "ore": 0, "star_silk": 0, "alien_relics": 0 },
...
function detectPoliticalStance(message: string): PoliticalStance {
  ...
  if (/your people|your faction|your exchange|your guild|your collective|your caravans|your clans/i.test(message)) {
    return 'pro_faction';
  }
  return 'neutral';
}
...
function resourceAliases(resourceId: ResourceId): string[] {
  const customAliases: Partial<Record<ResourceId, string[]>> = {
    ...
    food: ['food', 'rations?', 'ration packs?'],
    fuel: ['fuel[ _-]cells?', 'fuel', 'cells?'],
